...
class TestCalculateAverageOfEvens(unittest.TestCase):
    ...
    def test_positive_numbers(self):
        ...
        self.assertEqual(calculate_average_of_evens([3, 7, 2]), 4)

    def test_with_zero(self):
        """Test with zero included."""
        self.assertEqual(calculate_average_of_evens([0, 10, 5]), 5)

    def test_all_negative_num(self):
        """Test with all negative numbers."""
        self.assertEqual(calculate_average_of_evens([-5, -2, -8]), -5)

    def test_mixed_numbers(self):
        """Test with mixed positive and negative numbers."""
        self.assertEqual(calculate_average_of_evens([-10, 0, 5, -3, -2]), 3)